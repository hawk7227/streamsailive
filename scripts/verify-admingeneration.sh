...
check_grep "STREAMS_INTAKE_KEY" "src/app/api/intake/youtube/route.ts" "youtube intake accepts server-side intake key"
check_grep "x-streams-intake-key" "src/app/api/intake/youtube/route.ts" "youtube intake accepts x-streams-intake-key"
check_grep "x-intake-api-key" "src/app/api/intake/youtube/route.ts" "youtube intake accepts x-intake-api-key"
check_grep "x-admin-generation-key" "src/app/api/intake/youtube/route.ts" "youtube intake accepts admin generation key"
