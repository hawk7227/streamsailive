  ...
  return (
    <div className="streamsUniversalExperience" data-active-view="chat">
      ...
      <style jsx global>{`
        ...
        @media(max-width:900px){.experienceSwitcher{top:7px;left:58px;right:8px;height:42px;grid-template-columns:minmax(0,1fr) auto;padding-left:10px}.experienceModes{display:none}.experienceSwitcher .createProjectAction{min-width:96px}.experienceIdentity strong{font-size:11px}.experienceIdentity span{font-size:8px}}
        @media(max-width:560px){.experienceSwitcher{left:56px}.experienceSwitcher .createProjectAction{min-width:84px;padding:0 8px}.projectCreationBackdrop{padding:10px}.projectCreationDialog{max-height:calc(100svh - 20px);border-radius:14px;padding:14px}}
      `}</style>
    </div>
  );
}
