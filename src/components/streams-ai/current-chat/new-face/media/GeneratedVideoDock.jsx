...
export default function GeneratedVideoDock() {
  ...
  const dockStyle = isMobile ? { position: "fixed", left: open ? 0 : 16, right: open ? 0 : "auto", bottom: open ? 0 : 92, zIndex: 2400, width: open ? "100vw" : 52, maxHeight: open ? "86dvh" : 52, border: "1px solid rgba(222,222,222,.92)", borderRadius: open ? "22px 22px 0 0" : 18, background: "rgba(255,255,255,0.97)", boxShadow: "0 -18px 54px rgba(0,0,0,0.16)", overflow: "hidden", transition: "all .18s ease" } : { position: "fixed", left: 82, top: 86, zIndex: 2400, width: open ? 760 : 52, maxHeight: "calc(100dvh - 150px)", border: "1px solid rgba(222,222,222,.92)", borderRadius: 18, background: "rgba(255,255,255,0.96)", boxShadow: "0 18px 54px rgba(0,0,0,0.14)", overflow: "hidden", transition: "width .18s ease" };
