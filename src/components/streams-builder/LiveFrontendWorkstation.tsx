    ...
    <section className="liveWorkstation" aria-label="Live frontend workstation preview">
      ...
      <main className="previewSide">
        ...
        <footer className="toolStrip">
          ...
          <div><span>Mode</span><b>Live Frontend</b></div>
