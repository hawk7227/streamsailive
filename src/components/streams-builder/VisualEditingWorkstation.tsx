...
const initialLayers: Layer[] = [
  { id: "navbar", kind: "TEXT", label: "Navbar", component: "Navbar", file: "src/components/layout/Navbar.tsx", text: "", size: "14", width: "1366", weight: "700", line: "1", spacing: "0", align: "Left", color: "#ffffff", fill: "transparent" },
  { id: "hero-section", kind: "TEXT", label: "Hero Section", component: "Hero", file: "src/components/home/Hero.tsx", text: "", size: "42", width: "720", weight: "700", line: "1.05", spacing: "-1", align: "Center", color: "#ffffff", fill: "transparent" },
  { id: "features-section", kind: "CARD", label: "Features Section", component: "Features", file: "src/components/home/Features.tsx", text: "", size: "14", width: "1000", weight: "700", line: "1.35", spacing: "0", align: "Left", color: "#ffffff", fill: "transparent" },
  { id: "page-wrapper", kind: "ARTIFACT", label: "Page Wrapper", component: "Home", file: "src/app/page.tsx", text: "", size: "12", width: "1366", weight: "700", line: "1", spacing: "0", align: "Left", color: "#ffffff", fill: "transparent" },
];
  ...
  return (
    <section className="visualEditor">
      ...
      <main className={`canvas ${viewMode}`}>
        {viewMode === "browser" || viewMode === "editor" ? <div className="desktopFrame"><iframe key={frameKey} title={`${stationLabel} desktop browser proof`} src={sourceRoute} />{viewMode === "editor" ? <div className="editorOverlay"><button type="button" className={selectedId === "navbar" ? "active" : ""} onClick={() => selectLayer("navbar", "Navbar")}>Navbar</button><button type="button" className={selectedId === "hero-section" ? "active" : ""} onClick={() => selectLayer("hero-section", "Hero Section")}>Hero Section</button><button type="button" className={selectedId === "features-section" ? "active" : ""} onClick={() => selectLayer("features-section", "Features Section")}>Features Section</button><button type="button" className={selectedId === "page-wrapper" ? "active" : ""} onClick={() => selectLayer("page-wrapper", "Page Wrapper")}>Page Wrapper</button></div> : null}</div> : viewMode === "mobile" ? <div className="phoneFrame"><iframe key={frameKey} title={`${stationLabel} mobile proof`} src={sourceRoute} /></div> : <section className="frontView"><h1 className={selected.id === "navbar" ? "selected" : ""} style={{ fontSize: `${layers[0].size}px`, fontWeight: Number(layers[0].weight), lineHeight: layers[0].line, letterSpacing: `${layers[0].spacing}px`, color: layers[0].color }} onClick={() => selectLayer("navbar", "Navbar")}><b>{layers[0].label}</b></h1><p className={selected.id === "hero-section" ? "selected" : ""} style={{ fontSize: `${layers[1].size}px`, fontWeight: Number(layers[1].weight), lineHeight: layers[1].line, color: layers[1].color }} onClick={() => selectLayer("hero-section", "Hero Section")}>{layers[1].label}</p><button type="button" className={selected.id === "features-section" ? "cta selected" : "cta"} style={{ width: `${layers[2].width}px`, color: layers[2].color, background: layers[2].fill }} onClick={() => selectLayer("features-section", "Features Section")}>{layers[2].label}</button><article className={selected.id === "page-wrapper" ? "feature selected" : "feature"} style={{ width: `${layers[3].width}px`, background: layers[3].fill, color: layers[3].color }} onClick={() => selectLayer("page-wrapper", "Page Wrapper")}><b>{layers[3].label}</b></article></section>}
      </main>
