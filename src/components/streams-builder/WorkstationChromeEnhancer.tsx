...
export default function WorkstationChromeEnhancer() {
  ...
  return <style jsx global>{`
    ...
    .workstationShell>.stationViewport{grid-row:2!important;align-self:stretch!important;min-height:0!important;height:calc(100dvh - 82px)!important;overflow:hidden!important;}
    ...
    .liveWorkstation,.visualEditor{height:100%!important;min-height:0!important;}
    .liveWorkstation .previewSide{height:100%!important;min-height:0!important;grid-template-rows:44px auto minmax(0,1fr) auto auto!important;}
    .liveWorkstation .content,.liveWorkstation .content.full,.liveWorkstation .content.split{height:100%!important;min-height:0!important;align-items:stretch!important;}
    .liveWorkstation .frameWrap:not(.embedded){width:calc(100% - 20px)!important;height:calc(100% - 20px)!important;max-width:none!important;justify-self:stretch!important;align-self:stretch!important;}
    .liveWorkstation .codePreviewSplit,.visualEditor .splitMode{height:100%!important;min-height:0!important;display:grid!important;grid-template-columns:minmax(520px,1fr) minmax(520px,1fr)!important;grid-auto-flow:column!important;align-items:stretch!important;gap:10px!important;overflow:hidden!important;}
    ...
    .liveWorkstation .codePane,.visualEditor .codePanel,.liveWorkstation .codeOnly,.visualEditor .codeMode{display:grid!important;min-height:0!important;height:100%!important;overflow:hidden!important;}
    .runtimeCodeEditor{height:100%!important;min-height:0!important;}
