  ...
  return (
    <main className="universalWorkspaceShell" data-replacement-conversion="true" data-side-panels="removed">
      ...
      <style jsx global>{`
        ...
        @media(max-width:1100px){.workspaceBody{grid-template-columns:60px minmax(0,1fr)}.projectOverviewBlock{grid-template-columns:repeat(2,minmax(0,1fr))}.projectActions button:nth-of-type(-n+4){display:none}}
