...
export const streamsProjectProfile: ProjectBuildProfile = {
  id: "streams",
  packageManager: "pnpm",
  commands: {
...
const profiles: Record<string, ProjectBuildProfile> = {
  streams: streamsProjectProfile,
  generic: genericRepoProfile,
};

export function resolveProjectProfile(profileId?: string): ProjectBuildProfile {
  return profiles[profileId ?? "streams"] ?? genericRepoProfile;
}
