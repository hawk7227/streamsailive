...
function shouldUseWebGrounding(userContent: string) {
  return /\b(current|latest|recent|today|this year|2025|2026|market|research|sources?|citations?|trends?|statistics?|adoption|competitors?|launch|marketing|industry|news|pricing|compare|recommendations?)\b/i.test(userContent);
}
