...
export const OPENAI_IMAGE_MODEL = optional("OPENAI_IMAGE_MODEL", "gpt-image-1.5");
export const OPENAI_API_BASE_URL = optionalKey("OPENAI_API_BASE_URL");
export const IMAGE_MODEL = optional("IMAGE_MODEL", "gpt-image-1.5");
export const IMAGE_QUALITY = optional("IMAGE_QUALITY", "high");
